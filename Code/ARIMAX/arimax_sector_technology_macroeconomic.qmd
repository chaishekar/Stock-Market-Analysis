...
Endogenous variable: Technology Sector Fund
...
The RMSE cross-validation plot shows that the RMSE of Model 1 (0,1,0) is lower than that of Model 1 (0,2,1). This suggests that Model 1 (0,1,0) is a better fit for the data when compared other model.
##### Forecast

::: panel-tabset
### Forecast for  Technology Sector Fund with feature variable
